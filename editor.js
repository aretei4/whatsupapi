...
const DOCUMENT_SERVER_SECRET = 'fJ2lTiubmBQwXIrG9NfLFGEHbeQmwYsl'; // Must match Document Server config
...
const documentKey = Date.now() + "_" + Math.random().toString(36).substr(2);
 // const documentKey = 'doc8999-56123'; // Unique document ID
  ...
  <html>
    <head>
      <script src="http://13.204.49.246:8090//web-apps/apps/api/documents/api.js"></script>
    </head>
    <body>
...
app.use(cors({
  origin: 'http://localhost' // Replace with your Document Server URL
}));
